...
1. Download Overture divisions data: the areas, and the division records that carry each place's population
...
5. Download the [GHSL Urban Centre Database](https://human-settlement.emergency.copernicus.eu/ghs_ucdb_2024.php) (GHS-UCDB R2024A): named city polygons for places Overture has only as a point, such as London
6. Normalize everything: `python -m dataset.scripts.normalize_geodata`
...
aws s3 sync s3://overturemaps-us-west-2/release/2026-02-18.0/theme=divisions/type=division/ data/overture/division
```
...
Example for downloading the GHSL urban centres

```bash
curl -LO https://jeodpp.jrc.ec.europa.eu/ftp/jrc-opendata/GHSL/GHS_UCDB_GLOBE_R2024A/GHS_UCDB_GLOBE_R2024A/V1-1/GHS_UCDB_GLOBE_R2024A_V1_1.zip
unzip GHS_UCDB_GLOBE_R2024A_V1_1.zip GHS_UCDB_GLOBE_R2024A.gpkg -d data/ghsl
```
